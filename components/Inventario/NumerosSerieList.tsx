...
const NumerosSerieList: React.FC<NumerosSerieListProps> = ({ productos, ubicaciones, onRefresh }) => {
    ...
    const cargarNumeros = async () => {
        ...
        try {
            ...
            setSnackbarMessage(err.message || 'Error al cargar números de serie');
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            setSnackbarMessage('Número de serie actualizado');
            ...
            setSnackbarMessage(err.response?.data?.message || 'Error al actualizar');
            setSnackbarSeverity('error');
            setSnackbarOpen(true);
        } finally {
